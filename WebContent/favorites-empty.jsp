...
<a class="header-itemright" href="favorites-empty.jsp"  style="margin:15px">Favorites</a>
</header>
<section class="body-main" style="overflow-x:auto;">
                <h1 class="h1-left">Favorites</h1>
<p class="empcart">No items in Favorites.use'Add to Favorites' option in <a href="ShowMovieListCustomerServlet">Movie List.</a><p/>
