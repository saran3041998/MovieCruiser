...
public class MovieListDaoCollectionImpl implements MovieListDao {
	...
	public MovieListDaoCollectionImpl() 
	{
		if(movieList==null)
		{
			...
			movieList.add(new MovieList(0000001,"Avatar",278796508,true, DateUtil.convertToDate("28/09/1997"), "Science Fiction",true));
			movieList.add(new MovieList(0000002,"The Avengers",1518812988,true, DateUtil.convertToDate("18/04/1996"), "Superhero",false));
			movieList.add(new MovieList(0000003,"Titanic",1187463944,true, DateUtil.convertToDate("23/07/1996"), "Romance",false));
			movieList.add(new MovieList(0000004,"Jurassic World",1671713208,true, DateUtil.convertToDate("08/01/1996"), "Science Fiction",true));
			movieList.add(new MovieList(0000005,"Avengers: End Game",275076034,true, DateUtil.convertToDate("02/04/1996"), "Superhero",true));
			}
	...
	public List<MovieList> getMovieItemlistCustomer() {
		...
		{
			if(movielist.getDateOfLaunch().getTime()<=today.getTime() && movielist.isActive())
			{
