...
public static void testModifyMovieList() throws ParseException
{
	...
	MovieList movie=new MovieList(0000002,"Pirides of Pi",1187463956,true, DateUtil.convertToDate("03/07/1996"), "Thriller",false);
	MovieListDao movielistdao=movielistcollectionimpl;
	movielistdao.modifyMovieList(movie);
	System.out.println("Modify Movie Item : "+movielistdao.getMovie(0000002));
